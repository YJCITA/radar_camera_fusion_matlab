function helperPlotACCResults(logsout)
...
% driver_set_velocity, relative_distance, and safe_distance.
...
safe_distance = logsout.getElement('safe_distance'); % safe distance
%% Plot the results
...
hold on;
plot(safe_distance.Values.time,safe_distance.Values.Data,'b');grid on;
