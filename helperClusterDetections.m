classdef helperClusterDetections < driving.internal.SimulinkBusUtilities ...
...
%#codegen
    ...
    methods(Access=protected)
        ...
        function dt = getOutputDataTypeImpl(obj)
            dt = getOutputDataTypeImpl@driving.internal.SimulinkBusUtilities(obj);
        end
    ...
    methods(Static, Access=protected)
        ...
        function groups = getPropertyGroupsImpl
            ...
            slBusSection = getPropertyGroupsImpl@driving.internal.SimulinkBusUtilities;
